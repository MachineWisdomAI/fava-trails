...
async def recall_multi(
    ...
    # on_recall_mix: fire AFTER merging, only when multiple trails were searched.
    ...
    if primary and len(trail_managers) > 1 and primary._hooks and primary._hooks.has_hooks:
