# Trust Gate Prompt Example

This is a working example of a `trust-gate-prompt.md` file. Place it in your data repo's `trails/` directory (or a scope-specific subdirectory) as described in [AGENTS_SETUP_INSTRUCTIONS.md](AGENTS_SETUP_INSTRUCTIONS.md#trust-gate-prompts).
